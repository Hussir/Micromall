...
<div class="container-fluid">
    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            ...
            <li><a href="${pageContext.request.contextPath}/cart/list.page">购物车</a></li>
        </ol>
    </div>
</div>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/goods/list.page">首页</a>
            </div>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <input type="button" width="100" value="登录" name="submit" border="0" onclick="login()"
...
<div style="margin-top:50px;">
    <img src="${pageContext.request.contextPath}/img/footer.jpg" width="1346" height="78" alt="我们的优势" title="我们的优势"/>
</div>
...
<div style="text-align: center;margin-top: 5px;margin-bottom:20px;">
    Copyright &copy; 2005-2016 网易杭州研究院 版权所有
</div>
</body>
    ...
    function login() {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 101) {
                    window.location.href = "${pageContext.request.contextPath}/goods/list.page";
                } else {
